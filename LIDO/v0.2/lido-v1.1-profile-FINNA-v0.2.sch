...
<sch:schema xmlns:lido="http://www.lido-schema.org"
   ...
   <sch:pattern>
      ...
      <sch:rule context="lido:actorID[starts-with(., 'http://urn.fi/URN:NBN:fi:au:finaf:')]">
         <sch:assert test="@lido:source='finaf'" role="INFO">Missing or invalid source attribute of actorID: For KANTO actors, it is recommended to use the source attribute 'finaf'.</sch:assert>
      ...
      <sch:rule context="lido:actorID[@lido:source='finaf' and string(normalize-space(text()))!='']">
      ...
      <sch:rule context="lido:inscriptionDescription">
         ...
         <sch:assert test="not(@lido:type) or @lido:type='technique' or @lido:type='tekniikka' or @lido:type='location' or @lido:type='sijainti' or @lido:type='description' or @lido:type='kuvailu'"
                     role="WARN">Invalid type attribute of inscriptionDescription: If type attribute is in use, it should be one from "technique", "location" or "description".</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="lido:objectDescriptionSet">
         <sch:assert test="count(lido:descriptiveNoteValue[string(normalize-space(text()))]) &gt; 0"
                     role="WARN">Missing objectDescriptionSet/descriptiveNoteValue: objectDescriptionSet should have a non-empty descriptiveNoteValue.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="lido:placeID[starts-with(., 'http://www.yso.fi/onto/yso/')]">
         <sch:assert test="@lido:source='yso'" role="INFO">Missing or invalid source attribute of placeID: For YSO places, it is recommended to use the source attribute 'yso'.</sch:assert>
      ...
      <sch:rule context="lido:placeID[@lido:source='yso' and string(normalize-space(text()))!='']">
      ...
      <sch:rule context="lido:relatedWork">
         <sch:assert test="count(lido:displayObject[string(normalize-space(text()))]) &gt; 0"
                     role="WARN">Missing relatedWork/displayObject: relatedWork should have a non-empty displayObject.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="lido:subjectConcept/lido:conceptID[starts-with(., 'http://www.yso.fi/onto/yso/')]">
         <sch:assert test="@lido:source='yso'" role="INFO">Missing or invalid source attribute of conceptID: For YSO concepts, it is recommended to use the source attribute 'yso'.</sch:assert>
         <sch:assert test="@lido:type='http://terminology.lido-schema.org/lido00099' or @lido:type='URI'"
      ...
      <sch:rule context="lido:subjectConcept/lido:conceptID[starts-with(., 'http://www.yso.fi/onto/koko/')]">
         <sch:assert test="@lido:source='koko'" role="INFO">Missing or invalid source attribute of conceptID: For KOKO concepts, it is recommended to use the source attribute 'koko'.</sch:assert>
         <sch:assert test="@lido:type='http://terminology.lido-schema.org/lido00099' or @lido:type='URI'"
                     role="WARN">Missing or invalid type attribute of conceptID: For YSO concept URIs, the type attribute of conceptID should be 'http://terminology.lido-schema.org/lido00099' or 'URI'.</sch:assert>
      </sch:rule>
      <sch:rule context="lido:subjectConcept/lido:conceptID[@lido:source='yso' and string(normalize-space(text()))!='']">
      ...
      <sch:rule context="lido:subjectConcept/lido:conceptID[@lido:source='koko' and string(normalize-space(text()))!='']">
      ...
      <sch:rule context="lido:subjectConcept/lido:conceptID[string(normalize-space(text()))!='']">
         <sch:assert test="@lido:source" role="INFO">Missing source attribute of subjectConcept/conceptID: It is recommended to identify the source for subject concept ID.</sch:assert>
      </sch:rule>
      ...
      <sch:rule context="lido:titleSet/lido:appellationValue[string(normalize-space(text()))!='']">
         <sch:assert test="@xml:lang" role="INFO">Missing lang attribute in titleSet/appellationValue: It is recommended to specify the language of each title by using the lang attribute in appellationValue.</sch:assert>
